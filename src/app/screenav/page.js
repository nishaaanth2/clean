...
export default function Home() {
  return (
    <main className={cn("")}>
      ...
      <div
        role="status"
        class="p-8 space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center"
      >
      ...
      <div className=" flex flex-row w-full space-x-4 p-8">
      <div
        role="status"

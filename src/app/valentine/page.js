...
export default function Valentine() {
    ...
    return (
        <div className="w-screen h-screen flex item-center justify-center bg-[#acacac]">
            ...
            <div id="valentine-card" className={cn("h-[560px] w-full  min-[500px]:w-auto min-[500px]:aspect-[13/9] m-auto  relative p-7 bg-[#f4f3ef] shadow-2xl ",
